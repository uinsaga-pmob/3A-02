...
String formatSelisihHari(DateTime tanggal) {
  ...
  if (selisih == 1) return "3 hari yang lalu";
  return "$selisih hari yang lalu";
}

class Diary3Page extends StatefulWidget {
  final DiaryItem item;

  const Diary3Page({super.key, required this.item});

  @override
  State<Diary3Page> createState() => _Diary3PageState();
}

class _Diary3PageState extends State<Diary3Page> {
